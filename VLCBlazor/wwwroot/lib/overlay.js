...
central_play_icon.src = "_content/VlcBlazor/images/play_button.svg";

const play_button = new Image(BUTTON_SIZE, BUTTON_SIZE);
play_button.src = "_content/VlcBlazor/images/play.png";
const pause_button = new Image(BUTTON_SIZE, BUTTON_SIZE);
pause_button.src = "_content/VlcBlazor/images/pause.png";

const volume_button = new Image(BUTTON_SIZE, BUTTON_SIZE);
volume_button.src = "_content/VlcBlazor/images/volume-medium.png";
const muted_button = new Image(BUTTON_SIZE, BUTTON_SIZE);
muted_button.src = "_content/VlcBlazor/images/volume-muted.png";
