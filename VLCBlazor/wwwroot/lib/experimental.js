var initModule = (() => {
    ...
    return (function (initModule) {
        ...
        function __asyncjs__bindVideoFrame(pictureIdx) {
            return Asyncify.handleAsync(async () => {
                let frame = await Module.awaitFrame(pictureIdx);
                if (!frame)
                    return;
                let glCtx = Module.glCtx;
                glCtx.texImage2D(glCtx.TEXTURE_2D, 0, glCtx.RGBA, frame.codedWidth, frame.codedHeight, 0, glCtx.RGBA, glCtx.UNSIGNED_BYTE, frame)
            }
            )
        }
        ...
        function ___pthread_create_js(pthread_ptr, attr, start_routine, arg) {
                    ...
                    if (GL.offscreenCanvases[name]) {
                        ...
                        if (canvas.transferControlToOffscreen) {
                            if (!canvas.canvasSharedPtr) {
                                ...
                                HEAP32[canvas.canvasSharedPtr + 8 >> 2] = 0
                            }
                            offscreenCanvasInfo = {
            ...
            for (var i in offscreenCanvases) {
                HEAP32[offscreenCanvases[i].canvasSharedPtr + 8 >> 2] = pthread_ptr
            }
            var threadParams = {
        ...
        function ___syscall_dup3(fd, suggestFD, flags) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(8, 1, fd, suggestFD, flags);
            try {
                var old = SYSCALLS.getStreamFromFD(fd);
                assert(!flags);
                if (old.fd === suggestFD)
        ...
        function ___syscall_faccessat(dirfd, path, amode, flags) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(9, 1, dirfd, path, amode, flags);
            try {
        ...
        function ___syscall_getsockname(fd, addr, addrlen) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(17, 1, fd, addr, addrlen);
            try {
        ...
        function ___syscall_getsockopt(fd, level, optname, optval, optlen) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(18, 1, fd, level, optname, optval, optlen);
            try {
                var sock = getSocketFromFD(fd);
                if (level === 1) {
                    if (optname === 4) {
        ...
        function ___syscall_ioctl(fd, op, varargs) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(19, 1, fd, op, varargs);
            SYSCALLS.varargs = varargs;
            try {
                var stream = SYSCALLS.getStreamFromFD(fd);
                switch (op) {
        ...
        function ___syscall_listen(fd, backlog) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(20, 1, fd, backlog);
            try {
                var sock = getSocketFromFD(fd);
        ...
        function ___syscall_mkdirat(dirfd, path, mode) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(22, 1, dirfd, path, mode);
            try {
                path = SYSCALLS.getStr(path);
                path = SYSCALLS.calculateAt(dirfd, path);
                path = PATH.normalize(path);
        ...
        function ___syscall_newfstatat(dirfd, path, buf, flags) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(23, 1, dirfd, path, buf, flags);
            try {
                path = SYSCALLS.getStr(path);
        ...
        function ___syscall_openat(dirfd, path, flags, varargs) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(24, 1, dirfd, path, flags, varargs);
            SYSCALLS.varargs = varargs;
            try {
                path = SYSCALLS.getStr(path);
                path = SYSCALLS.calculateAt(dirfd, path);
        ...
        function ___syscall_pipe(fdPtr) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(25, 1, fdPtr);
            try {
                if (fdPtr == 0) {
        ...
        function ___syscall_poll(fds, nfds, timeout) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(26, 1, fds, nfds, timeout);
            try {
                var nonzero = 0;
        ...
        function ___syscall_recvmsg(fd, message, flags) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(28, 1, fd, message, flags);
            try {
                var sock = getSocketFromFD(fd);
        ...
        function ___syscall_renameat(olddirfd, oldpath, newdirfd, newpath) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(29, 1, olddirfd, oldpath, newdirfd, newpath);
            try {
        ...
        function ___syscall_rmdir(path) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(30, 1, path);
            try {
                path = SYSCALLS.getStr(path);
                FS.rmdir(path);
                return 0
        ...
        function ___syscall_sendmsg(fd, message, flags) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(31, 1, fd, message, flags);
            try {
                var sock = getSocketFromFD(fd);
                var iov = HEAPU32[message + 8 >> 2];
                var num = HEAP32[message + 12 >> 2];
        ...
        function ___syscall_sendto(fd, message, length, flags, addr, addr_len) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(32, 1, fd, message, length, flags, addr, addr_len);
            try {
                var sock = getSocketFromFD(fd);
        ...
        function ___syscall_socket(domain, type, protocol) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(33, 1, domain, type, protocol);
            try {
        ...
        function ___syscall_stat64(path, buf) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(34, 1, path, buf);
            try {
                path = SYSCALLS.getStr(path);
        ...
        function ___syscall_unlinkat(dirfd, path, flags) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(35, 1, dirfd, path, flags);
            try {
                path = SYSCALLS.getStr(path);
                path = SYSCALLS.calculateAt(dirfd, path);
                if (flags === 0) {
        ...
        function craftEmvalAllocator(argCount) {
            ...
            return new Function("requireRegisteredType", "Module", "valueToHandle", "HEAPU32", functionBody)(requireRegisteredType, Module, Emval.toHandle, HEAPU32)
        }
        var emval_newers = {};
        ...
        function __mmap_js(len, prot, flags, fd, off, allocated) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(37, 1, len, prot, flags, fd, off, allocated);
            try {
                var stream = FS.getStream(fd);
                if (!stream)
                    return -8;
        ...
        function __munmap_js(addr, len, prot, flags, fd, offset) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(38, 1, addr, len, prot, flags, fd, offset);
            try {
                var stream = FS.getStream(fd);
                if (stream) {
                    if (prot & 2) {
        ...
        function _tzset_impl(timezone, daylight, tzname) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(39, 1, timezone, daylight, tzname);
        ...
        function _eglGetDisplay(nativeDisplayType) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(40, 1, nativeDisplayType);
            EGL.setErrorCode(12288);
            return 62e3
        }
        ...
        function _emscripten_webgl_make_context_current_calling_thread(contextHandle) {
            ...
            if (success)
                GL.currentContextIsProxied = false;
            return success ? 0 : -5
        }
        var ENV = {};
        ...
        function _environ_get(__environ, environ_buf) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(41, 1, __environ, environ_buf);
            var bufSize = 0;
        ...
        function _environ_sizes_get(penviron_count, penviron_buf_size) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(42, 1, penviron_count, penviron_buf_size);
        ...
        function _fd_close(fd) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(43, 1, fd);
            try {
                var stream = SYSCALLS.getStreamFromFD(fd);
                FS.close(stream);
                return 0
        ...
        function _fd_fdstat_get(fd, pbuf) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(44, 1, fd, pbuf);
            try {
                var stream = SYSCALLS.getStreamFromFD(fd);
        ...
        function _fd_pread(fd, iov, iovcnt, offset_low, offset_high, pnum) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(45, 1, fd, iov, iovcnt, offset_low, offset_high, pnum);
            try {
        ...
        function _fd_read(fd, iov, iovcnt, pnum) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(46, 1, fd, iov, iovcnt, pnum);
            try {
                var stream = SYSCALLS.getStreamFromFD(fd);
        ...
        function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(47, 1, fd, offset_low, offset_high, whence, newOffset);
            try {
                var offset = convertI32PairToI53Checked(offset_low, offset_high);
                if (isNaN(offset))
                    return 61;
        ...
        function _fd_sync(fd) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(48, 1, fd);
            try {
                var stream = SYSCALLS.getStreamFromFD(fd);
        ...
        function _fd_write(fd, iov, iovcnt, pnum) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(49, 1, fd, iov, iovcnt, pnum);
            try {
                var stream = SYSCALLS.getStreamFromFD(fd);
        ...
        function _getaddrinfo(node, service, hint, out) {
            if (ENVIRONMENT_IS_PTHREAD)
                return _emscripten_proxy_to_main_thread_js(50, 1, node, service, hint, out);
            var addr = 0;
            var port = 0;
            var flags = 0;
            var family = 0;
        ...
        var proxiedFunctionTable = [null, _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_accept4, ___syscall_bind, ___syscall_connect, ___syscall_dup, ___syscall_dup3, ___syscall_faccessat, ___syscall_fcntl64, ___syscall_fdatasync, ___syscall_fstat64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_getpeername, ___syscall_getsockname, ___syscall_getsockopt, ___syscall_ioctl, ___syscall_listen, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_pipe, ___syscall_poll, ___syscall_recvfrom, ___syscall_recvmsg, ___syscall_renameat, ___syscall_rmdir, ___syscall_sendmsg, ___syscall_sendto, ___syscall_socket, ___syscall_stat64, ___syscall_unlinkat, _emscripten_set_canvas_element_size_main_thread, __mmap_js, __munmap_js, _tzset_impl, _eglGetDisplay, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_pread, _fd_read, _fd_seek, _fd_sync, _fd_write, _getaddrinfo];
        var ASSERTIONS = true;
        ...
        var _getDecoderWorker = Module["_getDecoderWorker"] = createExportWrapper("getDecoderWorker");
        var _saveSetjmp = Module["_saveSetjmp"] = createExportWrapper("saveSetjmp");
        var _tryGetPictureFromPool = Module["_tryGetPictureFromPool"] = createExportWrapper("tryGetPictureFromPool");
        ...
        var _ff_h264_cabac_tables = Module["_ff_h264_cabac_tables"] = 1450572;
